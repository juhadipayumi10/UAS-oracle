<?php @session_start();
 ...
 di tulis oleh : CITRA
 */
unset($_SESSION['payumi_282']);
if (ISSET($_SESSION['payumi_282']))
 {
...
<table width="400" border="1">
  ...
  <tr>
    ...
    <td width="275"><input name="payumi_282" type="text" id="payumi_282" /></td>
  </tr>
  <tr>
    <td><span class="style4">Password</span></td>
    <td><span class="style4">:</span></td>
    <td><input name="282" type="password" id="282" /></td>
  </tr>
  <tr>
